// -*- mode: c++ -*-
#ifndef _MAXRULEPROBABILITYKB_HPP_
#define _MAXRULEPROBABILITYKB_HPP_
...
inline void MaxRuleProbabilityKB::update_lexical(LBEdge& e, const LexicalDaughter& dtr)
{
...
inline void MaxRuleProbabilityKB::update_unary(UEdge& e, const UnaryDaughter& dtr)
{
...
inline void MaxRuleProbabilityKB::update_binary(LBEdge& e, const BinaryDaughter& dtr)
{
...
inline void MaxRuleProbabilityKB:: finalize()
{
...
inline void MaxRuleProbabilityKB::extend_derivation(PEdge* edge, unsigned i, bool licence_unaries)
{
...
inline void MaxRuleProbabilityKB::find_succ(PEdge* edge, packed_edge_probability_with_index& pep, bool licence_unaries)
{
