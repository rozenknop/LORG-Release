...
template<typename ProbaModel>
class MaxRuleUpdater
{
protected:
  static double update_maxrule_probability (const AnnotationInfo & up_annotations,
                                            const typename ProbaModel::BinaryDaughters & dtr,
                                            ...
                                            unsigned left_idx =0, unsigned right_idx = 0)
  {
    ...
    const ProbaModel & left  = dtr.left_daughter ()->get_edge (dtr.get_rule ()->get_rhs0 ());
    const ProbaModel & right = dtr.right_daughter ()->get_edge (dtr.get_rule ()->get_rhs1 ());
  ...
  void compute_best_indexes (const AnnotationInfo & up_annotations,
                            const typename ProbaModel::BinaryDaughters & dtrs,
                            double normalisation_factor,
                            unsigned &left_idx, unsigned &right_idx)
  {
    const ProbaModel & left =
    dtrs.left_daughter ()->get_edge (dtrs.get_rule ()->get_rhs0 ());
    const ProbaModel & right =
  ...
  double update_maxrule_probability (const AnnotationInfo & up_annotations,
                                    const typename ProbaModel::UnaryDaughters & dtrs,
                                    double normalisation_factor,
                                    unsigned left_idx = 0)
  {
  ...
  static  double update_maxrule_probability_simple (const AnnotationInfo & up_annotations,
                                            double normalisation_factor,
