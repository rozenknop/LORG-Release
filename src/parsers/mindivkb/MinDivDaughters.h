...
struct MinDivBRule : public BRuleC2f {
  ...
  double entropy_term(const std::vector<double>& up_out,
                      const std::vector<double>& left_in,
...
struct MinDivURule : public URuleC2f {
  ...
  double entropy_term(const std::vector<double>& out_up,
...
struct MinDivLRule : public LexicalRuleC2f {
  ...
  double entropy_term(const std::vector<double>& out_up) const;
};
...
//   MinDivBinaryDaughter(const MinDivBinaryDaughter&&other) : BinaryPackedEdgeDaughters<MinDivKBTypes>(other) {left=other.left; right=other.right; rule=other.rule;}
  inline MinDivBinaryDaughter(MinDivKBTypes::AEdge & le, MinDivKBTypes::AEdge & ri, const MinDivKBTypes::BRule * ru) : BinaryPackedEdgeDaughters<MinDivKBTypes>(le,ri,ru) {}
...
//   inline MinDivUnaryDaughter & operator=(MinDivUnaryDaughter && o) { *this = std::move(o); return *this; }
  inline MinDivUnaryDaughter(AEdge & le, const MinDivKBTypes::URule * ru) : UnaryPackedEdgeDaughters<MinDivKBTypes>(le,ru) {}
